  ...
  return (
    ...
    >
      <header className="flex w-full justify-between">
        ...
        <div className="mx-4 my-6">
          <Link
            className="rounded bg-[#e50a14] px-8 py-2 text-white"
            to="/login"
          >
            Sign in
          </Link>
      ...
      <main className="flex flex-1 flex-col items-center justify-center text-center sm:px-20">
        <h1 className="trackig-wide max-w-lg text-5xl font-bold text-white">
          Unlimited movies, TV shows, and more
        </h1>
        <h2 className="mb-8 mt-4 text-2xl text-white">
        ...
        <div className="m-4 flex flex-col space-y-6 sm:flex-row sm:space-y-0">
          ...
          />
          <button className="flex w-full items-center justify-center bg-[#e50914] py-2 text-xl text-white sm:px-8 sm:py-0">
            Get Started
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
